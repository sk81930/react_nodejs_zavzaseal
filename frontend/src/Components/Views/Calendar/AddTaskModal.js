...
const AddTaskModal = ({ isOpen, onClose, onAddEvent, dealsData, crewMembers, addTaskError, addTaskSuccess, clearFlash, setLoadEvent }) => {
  ...
  const handleAddTask = () => {
    ...
    if(selectedSearchOption && selectedSearchOption.value){
        ...
        if(typeof selectedSearchOption.value == "string"){
          deal_id = ""; 
        }else{
